...
int32_t main(){
    ...
    while(!Q.empty()){
        ...
        for(int dir = 0; dir < 4; dir++){
            ...
            if(dir != 0 and board[nx][ny] == 'U') continue;
            if(dir != 1 and board[nx][ny] == 'D') continue;
            if(dir != 2 and board[nx][ny] == 'L') continue;
            if(dir != 3 and board[nx][ny] == 'R' ) continue;
